...
uint8_t way_input_qwerty_to_code(char c)
{
	...
	static const uint8_t reverse_qwerty_map[128] = {
	    ...
	    ['-'] = 12, ['='] = 13,  ['q'] = 16, ['w'] = 17, ['e'] = 18,
	    ['r'] = 19, ['t'] = 20,  ['y'] = 21, ['u'] = 22, ['i'] = 23,
	    ['o'] = 24, ['p'] = 25,  ['['] = 26, [']'] = 27, ['a'] = 30,
	    ['s'] = 31, ['d'] = 32,  ['f'] = 33, ['g'] = 34, ['h'] = 35,
	    ['j'] = 36, ['k'] = 37,  ['l'] = 38, [';'] = 39, ['\''] = 40,
	    ['`'] = 41, ['\\'] = 43, ['z'] = 44, ['x'] = 45, ['c'] = 46,
	    ['v'] = 47, ['b'] = 48,  ['n'] = 49, ['m'] = 50, [','] = 51,
	    ['.'] = 52, ['/'] = 53,  [' '] = 57,
	};
...
void way_scroll_amount(int direction, int amount)
{
	...
	zwlr_virtual_pointer_v1_axis_discrete(
	    wl.ptr, 0, 0, wl_fixed_from_int(15 * direction * amount),
	    direction * amount);
...
void wayland_init(struct platform *platform)
{
	...
	platform->has_active_ripples =
	    NULL; // TODO: Implement ripple for Wayland
}
